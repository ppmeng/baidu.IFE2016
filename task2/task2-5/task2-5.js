...
function renderChart() {  
  ...
  /*var aqibar = document.getElementsByClassName("aqibar");
  for (var i = 0; i < aqibar.length; i++) {
    addEventHandler(aqibar[i], "mouseover", function(){
      var aqishow = document.createElement("div");
      aqishow.setAttribute("class", "aqishow");
      aqibar[i].appendChild(aqishow);
